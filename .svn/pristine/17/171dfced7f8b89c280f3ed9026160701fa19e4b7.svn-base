	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="width:80px;">'+rdata.localgoodstypeId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.localgoodstypeId+'" style="padding-left:5px" >'+rdata.localgoodstypeName+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.localgoodstypeId+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.localgoodstypeId+',1)">删除</a></div>');
       ...
       function doUpdate(id,a){
              ...
              if(a==0){
				   var json10 = {
				        ...
				        "data":{
				        "localgoodstypeId": id,
				        "localgoodstypeName": $("#meg2").val(),
				        "localgoodstypeSequnce": 0,	
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_goodstype.jsp";
				   ...
				   var json11 = {
				        ...
				        "data":{
				        "localgoodstypeId": id,
				        "localgoodstypeName": $("#n"+id).text(),
				        "localgoodstypeSequnce": 1,	
	             ...
	             if($("#meg10").val().length<2){
				  ...
				  $.ajax({
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_goodstype.jsp", target="tv");
             ...
             <div> 
                <ul>                   
	                ...
	                <li style="float: left;margin-left: -1px;">
	                   <input type="submit" value="添 加" class="list_input4" style="background:url(images/lan.jpg)" onclick="addtype()"
