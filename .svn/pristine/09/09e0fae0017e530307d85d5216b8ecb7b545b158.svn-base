	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="80px">'+rdata.companylicensetypeId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.companylicensetypeId+'" style="padding-left:5px" >'+rdata.companylicensetypeName+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.companylicensetypeId+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.companylicensetypeId+',1)">删除</a></div>');
       ...
       function doUpdate(id,a){
              ...
              if(a==0){
				   var json10 = {
				        "sendtype":10052,
				        "data":{
				        "companylicensetypeId": id,
				        "companylicensetypeName": $("#meg2").val(),
				        "companylicensetypeStatus": 0,	
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_licensetype.jsp";
				   ...
				   var json11 = {
				        ...
				        "data":{
				        "companylicensetypeId": id,
				        "companylicensetypeName": $("#n"+id).text(),
				        "companylicensetypeStatus": 1,	
	     ...
	     function addhmtype(){
	             ...
	             if($("#meg10").val().length<2){
   		         ...
   		         var json = {
			                "sendtype":10051,
					        "data":{		
					        "companylicensetypeName": $("#meg10").val(),							        				        
			      }};	     
				  $.ajax({
					   async:false,  		  
				       type:"post",                         
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_licensetype.jsp", target="tv");
