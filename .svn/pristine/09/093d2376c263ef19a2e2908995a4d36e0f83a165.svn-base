	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="width:80px;">'+rdata.localshoptypeId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.localshoptypeId+'" style="padding-left:5px;" >'+rdata.localshoptypeName+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.localshoptypeId+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.localshoptypeId+',1)">删除</a></div>');
       ...
       function doUpdate(id,a){
              ...
              if(a==0){
				   var json10 = {
				        ...
				        "data":{
				        "localshoptypeId": id,
				        "localshoptypeName": $("#meg2").val(),
				        "localshoptypeStatus": 0,	
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_shoptype.jsp";
				   ...
				   var json11 = {
				        ...
				        "data":{
				        "localshoptypeId": id,
				        "localshoptypeName": $("#n"+id).text(),
				        "localshoptypeStatus": 1,	
	             ...
	             if($("#meg10").val().length<2){
				  ...
				  $.ajax({
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_shoptype.jsp", target="tv");
