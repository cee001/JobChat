	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="80px">'+rdata.papertypeId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.papertypeId+'" style="padding-left:5px" >'+rdata.typename+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.papertypeId+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.papertypeId+',1)">删除</a></div>');
              ...
              if(a==0){
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_papertype.jsp";
	             ...
	             if($("#meg10").val().length<2){
				  ...
				  $.ajax({
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_papertype.jsp", target="tv");
