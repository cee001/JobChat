...
public class CompanylicensetypeService {
	...
	//分页获取数量	
	public int getcount(){
		String hql="select count(*) from JCompanylicensetype where companylicensetypeStatus = '0'";
		return Integer.parseInt(cd.getObjects(hql).get(0).toString());
	}
	//分页获取
	@SuppressWarnings("unchecked")
	public ArrayList<JCompanylicensetype> getJCompanylicensetypeByPageNum(int pageNum,int pageSize){
		String hql="from JCompanylicensetype where companylicensetypeStatus = '0'";
