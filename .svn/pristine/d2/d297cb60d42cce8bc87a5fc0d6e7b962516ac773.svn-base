	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				     ...
				     $(data3).each(function(index,rdata){
			          ...
			          var strtitle=rdata.publicmessagesName;                                   
				      var t1=strtitle;
		  	          var datatitle=t1;	
				      if(t1.length>28){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;width:80px;font-size:13px;">'+rdata.publicmessagesId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;padding-left: 5px;"><a onclick="changeif(1)" href="detail_publicmsg.jsp?mid='+rdata.publicmessagesId+'" target="tvc">'+strtitle+'</a></div>');
				     $("#dmsgid3").html($("#dmsgid3").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;">'+num+'/'+rdata.publicmessagesReadnum+'</div>'); 				     
		          	 $("#dmsgid4").html($("#dmsgid4").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;">'+rdata.SUser.userNikename+'</div>');				     
				     $("#dmsgid5").html($("#dmsgid5").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;">'+rdata.publicmessagesTime+'</div>');  
		          	 $("#dmsgid6").html($("#dmsgid6").html()+'<div style="border-bottom:1px solid;border-bottom-color:#B2DFEE;font-size:13px;"><a href="#" onclick="doUpdate('+rdata.publicmessagesId+')">删除</a></div>');
             ...
             if(confirm("确定删除吗？")){
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_publicmsg.jsp";
