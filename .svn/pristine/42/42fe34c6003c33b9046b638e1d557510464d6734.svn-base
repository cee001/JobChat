        ...
        function showconr(){ 
		  ...
		  $.ajax({
		       ...
		       success:function(d){	
                       ...
                       $("#ljop1").html('<div style="font-size:16px;color:red;margin-top: 100px;text-align:center;">添加成功!<br></div>');
       	   ...
       	   function GetJsonData1() {
   		         ...
   		         var json = {
			                "sendtype":20166,
					        "data":{		
					        "publictypeId": $("#meg2").val(),							        			
					        "publictypeName": $("#meg1").val(),	
					        "publictypeSequnce": $("#meg5").val(),
              ...
              <ul>
                <li id="ljop1" style="width:995px;">
                    ...
                    <table style="width:100%;font-size: 微软雅黑;">
	                    ...
	                    <tr>
		                    <td style="padding-left: 150px;height:70px;" colspan="4">编&nbsp;号:
		                        <input class="f2g_p2" id="meg2" onfocus="clear2()" type="text" name="price" >
		                    </td>
	                    </tr>
	                    <tr>
		                    <td style="padding-left: 150px;height:70px;" colspan="4">排&nbsp;序:
		                        <input class="f2g_p2" id="meg5" onfocus="clear2()" type="text" name="price" >
		                    </td>
	                    </tr>	
	                    <tr>
