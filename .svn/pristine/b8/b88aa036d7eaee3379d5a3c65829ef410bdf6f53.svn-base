	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="80px">'+rdata.id+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.id+'" style="padding-left:5px" >'+rdata.name+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.id+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.id+',1)">删除</a></div>');
              ...
              if(a==0){
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_keyword.jsp";
	             ...
	             if($("#meg10").val().length<2){
				  ...
				  $.ajax({
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_keyword.jsp", target="tv");
  ...
  <body>
   ...
   <div id="dvmsgid">
    <table border="1" bordercolor="#B2DFEE" align="center" class="list_table1" >   
      ...
      <tr>     
          <td colspan="3" >	       
	       	<div class="list_div10" ><b>添加关键词</b></div>            	    
          </td>   
      </tr>
      <tr>     
      ...
      <tr>     
          <td colspan="3"><div class="list_div10"><b>列表关键词</b></div></td>   
      </tr >             
      <tr align="center">     
          <td width="80px">ID</td>   
          <td>类别名称</td>   
