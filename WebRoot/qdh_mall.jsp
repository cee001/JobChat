...
<html>
  ...
  <body>
       ...
       <div id="divv">	
          <ul>             			            
             <li onclick="openhref('com!showlist2.action?ruid=')" onmousemove="changedh(1)" onmouseout="rechangedh(1)"
                 style="margin-left: 0px;width:200px;background:#525252;">
                 <div style="float: left;margin-left: 55px">全部商品分类</div><div style="float: left;margin-top: 0px;margin-left: 3px;"><b >﹀</b></div>                                                                                                   
             </li>  
             <li id="ll2" onclick="openhref('Tjthome.html')" onmousemove="changedh(2)" onmouseout="rechangedh(2)" style="margin-left: 60px">首页</li>
