	     ...
	     function getdata(m){  
	           ...
	           $.ajax({   
				  ...
				  $(data2).each(function(index,rdata){
				     ...
				     $("#dmsgid1").html($("#dmsgid1").html()+'<div class="list_div1" style="80px">'+rdata.companywelfaretypeId+'</div>');
				     $("#dmsgid2").html($("#dmsgid2").html()+'<div class="list_div1" id="n'+rdata.companywelfaretypeId+'" style="padding-left:5px" >'+rdata.companywelfaretypeName+'</div>');	
		          	 $("#dmsgid3").html($("#dmsgid3").html()+'<div class="list_div1"><a href="#" onclick="showUpdate('+rdata.companywelfaretypeId+',0)">修改</a>&nbsp;<a href="#" onclick="doUpdate('+rdata.companywelfaretypeId+',1)">删除</a></div>');
       ...
       function doUpdate(id,a){
              ...
              if(a==0){
				   var json10 = {
				        "sendtype":10049,
				        "data":{
				        "companywelfaretypeId": id,
				        "companywelfaretypeName": $("#meg2").val(),
				        "status": 0,	
                ...
                $.ajax({
				       ...
				       success:function(d){	
		                          ...
		                          window.location.href="list_welfaretype.jsp";
				   ...
				   var json11 = {
				        ...
				        "data":{
				        "companywelfaretypeId": id,
				        "companywelfaretypeName": $("#n"+id).text(),
				        "status": 1,	
	     ...
	     function addhmtype(){
	             ...
	             if($("#meg10").val().length<2){
   		         ...
   		         var json = {
			                "sendtype":10048,
					        "data":{		
					        "companywelfaretypeName": $("#meg10").val(),							        				        
			      }};	     
				  $.ajax({
					   async:false,  		  
				       type:"post",                         
				       ...
				       success:function(d){	
		                       ...
		                       window.open("list_welfaretype.jsp", target="tv");
