...
public class UserService {
	...
	//通过电话单个获取用户
	public JUser findUserOutID(int id){
		JUser u=null;
		String hql="from JUser where user_outid='"+id+"'";
		@SuppressWarnings("rawtypes")
		List ls=cd.getObjects(hql);
		if(ls!=null&&ls.size()>0){
			System.out.println("ok");
